  ...
  <body>
    ...
    <div style="position: relative; top: 60px; right: -150px">
        <form action="{{url('/update',$data->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div>
                <label style="color:#fff ;font-family: Lucida Console;margin-left:15px;">OldImage :</label>
                <img width="200" style="margin-left:15px;" height="200" src="/productimage/{{$data->image}}">
            </div><br>
            <div>
                <label style="color:#fff ;font-family: Lucida Console;margin-left:15px;">New Image :</label>
